                ...
                Task.Run(async () =>
                {
                    ...
                    foreach (var IdAutoBanSet in Program.cfgjson.AutoBanIds)
                    {
                        ...
                        if (e.Member.Id > IdAutoBanSet.LowerBound && e.Member.Id < IdAutoBanSet.UpperBound)
                        {
                            ...
                            await dmScamLog.SendMessageAsync($"{Program.cfgjson.Emoji.Banned} Automatically appeal-banned {e.Member.Mention} for matching the creation date of the {IdAutoBanSet.Name} DM scam raiders.");
                        }
                    }
